...
GENERATED_DIR = os.path.join(PROJECT_ROOT, "data/generated/qnas/")
...
if __name__ == "__main__":
    def create_qna_from_folder(generator, validator, input_dir=CLEANED_JSON_DIR, output_dir=GENERATED_DIR, time_delay_seconds=5):
    ...
    try:        
        ...
        create_qna_from_folder(generator_llm, validator_llm, CLEANED_JSON_DIR, GENERATED_DIR)
