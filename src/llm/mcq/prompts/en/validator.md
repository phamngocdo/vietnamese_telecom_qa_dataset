...
RETURN ONLY A SINGLE BOOLEAN ARRAY. The array must have the exact same number of elements as the input qna_list. DO NOT add any explanatory text, greetings, or Markdown. Your response must START with [ and END with ].
